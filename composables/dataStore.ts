...
const initial = [
  {
    ...
    elId: '',
    classes:
      'thisRoot min-h-screen w-full relative pb-100px justify-between items-center !relative',
    css: '',
    children: [
      {
        id: '1',
        ...
        children: [
          {
            ...
            elId: '6',
            classes: 'bg-black h-[100px] w-[100px] absolute',
        ...
        children: [
          {
            ...
            content: 'section',
            elId: '',
            classes: 'bg-yellow-500 h-[100px] w-[100px] absolute ',
            css: '',
            children: [],
          },
          {
            ...
            content: 'section',
            elId: '',
            classes: 'bg-blue-500 h-[100px] w-[100px] absolute',
          ...
          },
          {
            ...
            content: 'Hello World',
            elId: '5',
            classes: 'bg-indigo-500 h-[100px] w-[100px] absolute',
